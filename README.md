...
Paper and related materials for  [Spirling](http://arthurspirling.org/) and [Stewart](https://scholar.princeton.edu/bstewart/home) (2024). The abstract for the paper is as follows:
...
You can find a preprint of the paper [here](https://github.com/ArthurSpirling/InferenceToTheBestExplanation/blob/main/paper/Spirling_Stewart_WhatGoodIsARegression.pdf). It is now (conditionally) accepted for publication at [Journal of Politics](https://www.journals.uchicago.edu/toc/jop/current) but we are still very interested in comments. Please email us or open an `issue` here. 
